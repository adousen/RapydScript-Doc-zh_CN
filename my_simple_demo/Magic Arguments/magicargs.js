(function(){
    ...
    var JSON, str, y, args_list1, a, b, args_list2;
            JSON = JSON || {};
    if (!JSON.stringify) {
    ...
    function test(foo, bar, kw) {
        _$rapyd$_print(foo);
        _$rapyd$_print(bar);
        _$rapyd$_print(kw);
        _$rapyd$_print(kw["foo"]);
    }
    
    function test_kwargs(foo, bar, kw) {
        _$rapyd$_print(foo);
        _$rapyd$_print(bar);
        _$rapyd$_print(kw);
        _$rapyd$_print(kw["foo"]);
    ...
    test_kwargs({bar: 3, foo: 1, kw: {
        foo: 1,
        bar: 3
    }});
    function my_func1(m, n) {
        _$rapyd$_print(m);
        _$rapyd$_print(n);
    }
    my_func1({n: "She was here", m: "He was here"});
    
    function my_func2(m, n) {
        _$rapyd$_print(m);
        _$rapyd$_print(n);
    }    my_func2 = kwargs(my_func2);
    ...
    function my_print() {
        ...
        console.log.apply(console, [m].concat(args));
    }
    my_print(y, a, b);
    a = "I was there";
    b = "and there";
    args_list2 = [a, b];
    function depacking_print(m, n, p) {
        if (typeof p === "undefined") p = "\n She is there!";
        console.log(m, n, p);
    }
    depacking_print.apply(this, [].concat(args_list2));
})();