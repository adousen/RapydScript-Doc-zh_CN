(function(){
    ...
    var str, foo, index_test, num, $canvas, canvas, hash, obj;
            str = JSON.stringify;
    function kwargs(f) {
        var argNames;
    ...
    hash["bar"]();
    index_test = "abcdefg";
    _$rapyd$_print(index_test[index_test.length-2]);
    num = 3;
    _$rapyd$_print(index_test[-num]);
    ...
    console.log(Object.keys(obj));
    _$rapyd$_print(obj.propertyIsEnumerable());
})();